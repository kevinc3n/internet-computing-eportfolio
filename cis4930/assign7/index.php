...
<html>
    <head>
      ...
      <link href="assign7_style.css" rel="stylesheet" type="text/css">
      <link rel="icon" type="image/x-icon" href="../assign6/assign6_files/music.gif">
            ...
            <div class="card-body">
                ...
                <div class="input-group">
                  <div class="input-group-prepend">
                    <span class="input-group-text iconSize"><i class="fas fa-search"></i></span>
                  </div>
                  <input type="text" name="searchBox" class="form-control questionText" placeholder="Search by Song Title...">
                </div>
                ...
                <fieldset class="border p-3">
                    <div class="table-responsive">
                        <table id="songTable" class="table table-striped table-bordered">
                        <thead>
                            <tr>
                    ...
                    <a href="assign7_files/ERD.png" class="dataFormat"> View the Entity Relationship Diagram for this Database Table </a>
